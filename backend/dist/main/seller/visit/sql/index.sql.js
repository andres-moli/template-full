...
exports.QUERY_VISIT_STATUS_BY_COMENT = exports.QUERY_VISIT_STATUS_BY_DATE = void 0;
const QUERY_VISIT_STATUS_BY_DATE = (dateInt, dateFinish) => {
    return `
	SELECT
...
exports.QUERY_VISIT_STATUS_BY_DATE = QUERY_VISIT_STATUS_BY_DATE;
const QUERY_VISIT_STATUS_BY_COMENT = (dateInt, dateFinish) => {
    return `SELECT
	MAX(u.name) as trabajador
...
exports.QUERY_VISIT_STATUS_BY_COMENT = QUERY_VISIT_STATUS_BY_COMENT;
//# sourceMappingURL=index.sql.js.map