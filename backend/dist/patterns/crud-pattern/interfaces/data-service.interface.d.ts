...
export interface IDataService<PrimaryKeyType, EntityType extends IDataEntity<PrimaryKeyType>, FindArgsType extends IFindArgs = DefaultArgs, ContextType extends IContext = IContext, MetadataPaginationType extends MetadataPagination = MetadataPagination> {
    getRepository(context: ContextType): Repository<EntityType>;
    getQueryBuilder(context: ContextType, args?: FindArgsType): SelectQueryBuilder<EntityType>;
    ...
    findOne(context: ContextType, id: PrimaryKeyType, orFail?: boolean): Promise<EntityType>;
    Audit(context: ContextType, action: string, objectId?: PrimaryKeyType, valueBefore?: object, valueAfter?: object): Promise<void>;
}
