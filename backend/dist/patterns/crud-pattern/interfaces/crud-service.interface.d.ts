...
export interface ICrudService<PrimaryKeyType, EntityType extends IDataEntity<PrimaryKeyType>, CreateInputType extends DeepPartial<EntityType>, UpdateInputType extends DeepPartial<EntityType>, FindArgsType extends IFindArgs = DefaultArgs, ContextType extends IContext = IContext> extends IDataService<PrimaryKeyType, EntityType, FindArgsType, ContextType> {
    create(context: ContextType, createInput: CreateInputType, eventHandler?: ICreateEventsHandler<PrimaryKeyType, EntityType, CreateInputType, ContextType>): Promise<EntityType>;
    update(context: ContextType, id: PrimaryKeyType, updateInput: UpdateInputType, eventHandler?: IUpdateEventsHandler<PrimaryKeyType, EntityType, UpdateInputType, ContextType>): Promise<EntityType>;
